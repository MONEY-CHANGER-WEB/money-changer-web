    ...
    <div className="home-page">
      ...
      <div className="home-container2">
        <div className="home-img">
          <img
            src="https://www.esade.edu/beyond/wp-content/uploads/2026/01/img_persona-trabajando-en-una-oficina-frente-a-varias-pantallas-que-exhiben-graficos-financieros.jpg"
            alt=""
          />
        </div>
